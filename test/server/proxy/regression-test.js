...
describe('Regression', () => {
    ...
    it('Should not change request headers to lowercase (GH-1380)', () => {
        ...
        return request(options)
            .then(rawHeadersNames => {
                expect(JSON.parse(rawHeadersNames.body)).to.include.members(['if-none-match', 'X-Requested-With', 'ConTEnt-tyPE']);
            });
    });
    ...
    it('Should not change the Cookie request headers to lowercase (GH-2382)', () => {
        ...
        return request(options)
            .then(rawHeadersNames => {
                expect(JSON.parse(rawHeadersNames.body)).to.include.members(['Referer', 'Cookie']);
            ...
            .then(rawHeadersNames => expect(JSON.parse(rawHeadersNames.body)).to.include.members(['referer', 'cookie']));
    });
