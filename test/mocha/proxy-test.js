...
describe('Proxy', function () {
    ...
    before(function () {
        ...
        app.get('/page', function (req, res) {
            ...
            res.end(fs.readFileSync('test/mocha/data/page/src.html').toString());
        });

        app.get('/script', function (req, res) {
            res.set('content-type', 'application/javascript; charset=utf-8');
            res.end(fs.readFileSync('test/mocha/data/script/src.js').toString());
        });

        app.get('/stylesheet', function (req, res) {
            res.end(fs.readFileSync('test/mocha/data/stylesheet/src.css').toString());
        });

        app.get('/manifest', function (req, res) {
            res.set('content-type', 'text/cache-manifest');
            res.end(fs.readFileSync('test/mocha/data/manifest/src.manifest')).toString();
        });
