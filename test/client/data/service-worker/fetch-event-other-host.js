...
self.addEventListener('fetch', e => {
    if (e.request.url === 'https://example.com/path/iframe-created-from-service-worker.html') {
        e.respondWith(new Response('<img src="http://' + location.host + '/sessionId/https://example123.com/img.png">', {
            headers: { 'Content-Type': 'text/html' }
        }));
    }
    else if (e.request.url === 'https://example123.com/img.png') {
        callbackPort.postMessage('image requested');
