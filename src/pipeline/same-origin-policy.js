...
export function check (ctx) {
    ...
    var xhrHeader     = ctx.req.headers[Const.XHR_REQUEST_MARKER_HEADER];
    var corsSupported = !!(xhrHeader & Const.XHR_CORS_SUPPORTED_FLAG);
    ...
    var withCredentials        = xhrHeader & Const.XHR_WITH_CREDENTIALS_FLAG;
