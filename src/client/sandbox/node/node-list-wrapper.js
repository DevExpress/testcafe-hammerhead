export default class NodeListWrapper {
    constructor (nodeList, filterListFn, filterItemFn) {
        ...
        if (this.nodeList.namedItem)
            this.nodeList.namedItem = (...args) => this.nodeList.namedItem.apply(this.nodeList, args);
    ...
    static _refreshNodeList () {
        ...
        for (i = this.nodeList.length; i >= this.filteredNodeList.length; i--)
