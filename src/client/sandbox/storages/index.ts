...
class StorageSandboxProxyStrategy implements StorageSandboxStrategy {
    ...
    localStorageProxy: StorageProxy | null = null;
    sessionStorageProxy: StorageProxy | null = null;
...
export default class StorageSandbox extends SandboxBase {
    ...
    public static _wrapKey (key: string): string {
        const keyStr = String(key);

        return STORAGE_PROPS.indexOf(keyStr) !== -1 ? API_KEY_PREFIX + keyStr : keyStr;
    }

    public static _unwrapKey (key: string): string {
